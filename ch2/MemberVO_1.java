...
// 자기 클래스 안에서
	...
	// 매개변수 2개있는 생성자
	public MemberVO_1( String mid,String mpw){
		this.mid = mid;
		this.mpw = mpw;
	...
	// 매개변수 5개있는 생성자 
	// 이렇게 초기화 해도 되고
	public MemberVO_1( String mname,String mid,String mpw,String mhp,String maddr){
		this.mname = mname;
		this.mid = mid;
		this.mpw = mpw;
		this.mhp = mhp;
...
// Bean : 콩
// com : 데이터를 담는 통
// 현대 코딩에서 모든 데이터는 VO에 담아서 프로그램을 한다.
// VO : Value Object -> 클래스명 뒤에 대문자로 접미어 표기.
// 멤버변수를 private -> 은닉화 (encapsulation)
// -> 은닉화한 데이터를 setter() 함수로 초기화하고,
//                  getter() 함수로 리턴하여 사용한다.
// getter() 함수 사용 시 -> 기본생성자(매개변수가 없는 생성자)를 이용하고
//                       또는 사용 방법에 따라 
// 생성자(매개변수가 있는 생성자)를 이용해서 멤버필드를 초기화 할 수 있다.

// 깡통 클래스 / Value Object 클래스 / DTO 클래스